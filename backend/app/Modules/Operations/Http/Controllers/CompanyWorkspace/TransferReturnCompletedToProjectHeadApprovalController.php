...
final class TransferReturnCompletedToProjectHeadApprovalController
{
    ...
    public function __invoke(
        ...
        $updated = $lifecycle->returnCompletedEmployeeToProjectHeadApproval($project, $transfer, $actor, $user, $comment);
