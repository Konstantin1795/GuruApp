...
final class SubmitReportController
{
    ...
    public function __invoke(
        ...
        $updated = $lifecycle->submitFromCreated($project, $report, $actor, $request->user());

        return ApiResponse::ok([
            'report' => (new ReportOperationResource($updated))->resolve(),
        ]);
    }
}
