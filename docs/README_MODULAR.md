...
- **`docs/90_current/TZ_Company_Dashboard_Analytics_Report_Transfer.md`** — ТЗ по аналитике главного экрана Company Workspace; **MVP в коде:** `CompanyDashboardAnalyticsService`, `GET …/dashboard/analytics*`, Flutter `CompanyDashboardScreen`, `CompanyDashboardAnalyticsTest`.
